...
SET @dynamic_query = CONCAT(@dynamic_query, '
	...
	INNER JOIN	s_product_header_pos_component sphpc ( NOLOCK )
		ON sphpc.product_header_code = sphl.product_header_code

	INNER JOIN	s_pos_component spc ( NOLOCK )
		ON spc.pos_component_code = sphpc.pos_component_code
